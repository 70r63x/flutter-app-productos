...
class ProductosProvider {
  final String _url = 'https://flutter-crud-4ea28-default-rtdb.firebaseio.com';
  ...
  Future<List<ProductoModel>> cargarProductos() async {
    ...
    final List<ProductoModel> productos = List.empty(growable: true);
  ...
  Future<String> subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/x70r63x/image/upload?upload_preset=axkfytnp');
